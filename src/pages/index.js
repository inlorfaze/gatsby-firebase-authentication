...
const LandingPage = () => (
  <Fragment>
    <Helmet
      title="PolyTalent - Home"
      meta={[
        { name: "description", content: "The online marketplace for talented student freelancers. For students, by students." },
        { name: "keywords", content: "student, freelance, marketplace, talent, polytalent" }
      ]}
    />
